...
public class ServiceHandler {
     ...
     */
    public String makeServiceCall(String url, int requestmethod) {
        return this.makeServiceCall(url, requestmethod, null);
    }
    /**
     * Making web service call
     *
     ...
     */
    public String makeServiceCall(String urladdress, int requestmethod,
